    ...
    <div className={classes.whitepaperContainer}>
      <div className={classes.whitepaperContent}>
        ...
        <p>
          ...
          only learn, but also connect genuinely and positively with one
          another.
        </p>
        <h3>Education</h3>
        <p>
          ...
          avoid being scammed. Then, clarify other fundamental tasks like
          ...
          NEWbie University, and as we continue to develop, we will be creating
          additional focused content for our more advanced and dedicated
          members.
        </p>
        <h3>Alpha</h3>
        <p>
